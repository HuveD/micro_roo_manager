...
4.  **Report Outcome:**
    *   **On Success:**
        ...
        - **Crucially, in the `## Summary of Changes` section, provide a clear and detailed description of the exact modifications made in this step.** This prevents repeating the same work. Example: "Refactored `process_data` in `processor.py` by extracting helper `_validate_input` as per spec doc section 4.1. Verified file content and basic functionality post-modification."
