...
3.  **Delegate Loop:**
    a.  Select the first/next subtask based on the SRP-driven plan derived from the request.
    ...
    f. Repeat until all subtasks derived from the initial request are done or a definitive blocker is identified.
