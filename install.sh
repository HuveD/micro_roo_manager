...
curl -L -o micro_roo_manager.zip https://github.com/HuveD/micro_roo_manager/archive/refs/heads/ai-sparc.zip
...
# Move to extracted directory (ai-sparc branch)
EXTRACTED_DIR="tmp_micro_manager/micro_roo_manager-ai-sparc"
